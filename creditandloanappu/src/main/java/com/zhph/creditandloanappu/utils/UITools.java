...
public class UITools {
    ...
    public static void elasticPadding(final ScrollView scrollView, final int padding) {
        ...
        scrollView.getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            private void scrollToBottom() {
                scrollView.smoothScrollTo(scrollView.getScrollX(), scrollView.getChildAt(0).getBottom() - scrollView
                        .getMeasuredHeight() - padding + oldpb);
            }
            ...
            public void onGlobalLayout() {
                ...
                scrollView.getViewTreeObserver().addOnScrollChangedListener(new OnScrollChangedListener() {
                    ...
                    public void onScrollChanged() {
                        if (!inTouch && scrollView != null && scrollView.getHandler() != null) {//如果持续滚动,
                            // 移除checkStopped,停止滚动以后只执行一次检测任务
                            scrollView.getHandler().removeCallbacks(checkStopped);
                            scrollView.postDelayed(checkStopped, 50);
                        }
                    }
                });
    ...
    public static void elasticPadding(final HorizontalScrollView scrollView, final int padding) {
        ...
        //记录以前的padding
        final int oldpt = child.getPaddingLeft();
        final int oldpb = child.getPaddingRight();
        //设置新的padding
        child.setPadding(padding, 0, padding, 0);
        scrollView.smoothScrollTo(padding, scrollView.getScrollY());
        ...
        scrollView.getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            private void scrollToRight() {
                scrollView.smoothScrollTo(scrollView.getChildAt(0).getRight() - scrollView.getMeasuredWidth() -
            ...
            public void onGlobalLayout() {
                ...
                //第一次加载视图,复原位置
                scrollView.postDelayed(checkStopped, 0);
            }
        });
    }
}
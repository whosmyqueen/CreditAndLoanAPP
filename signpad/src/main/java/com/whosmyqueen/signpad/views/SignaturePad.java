...
public class SignaturePad extends View {
    ...
    public SignaturePad(Context context, AttributeSet attrs) {
        ...
        //Configurable parameters
        try {
            mMinWidth = a.getDimensionPixelSize(R.styleable.SignaturePad_penMinWidth, convertDpToPx
                    (DEFAULT_ATTR_PEN_MIN_WIDTH_PX));
            mMaxWidth = a.getDimensionPixelSize(R.styleable.SignaturePad_penMaxWidth, convertDpToPx
                    (DEFAULT_ATTR_PEN_MAX_WIDTH_PX));
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                mLastUpX = eventX;
                mLastUpY = eventY;
                if (Math.abs(eventX - mLastTouchX) > 0 || Math.abs(eventY - mLastTouchY) > 0) {
                    lineCount++;
                    isMove = true;
                }
                getParent().requestDisallowInterceptTouchEvent(true);
    ...
    public Bitmap getSignatureBitmap() {
        ...
        Bitmap whiteBgBitmap = Bitmap.createBitmap(originalBitmap.getWidth(), originalBitmap.getHeight(), Bitmap
                .Config.ARGB_8888);

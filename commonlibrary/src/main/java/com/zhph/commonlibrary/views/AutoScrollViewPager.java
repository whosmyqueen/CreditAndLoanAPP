    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.abs(moveY - downY1) > Math.abs(moveX - downX1)) {
                    //夫控件拦截事件
                    Log.e("tag", "cut");
                    ...
                    if (moveX - downX1 < 0 && getCurrentItem() == getAdapter().getCount() - 1) {
                        //跳转整个模块，夫控件要去拦截事件
                        getParent().requestDisallowInterceptTouchEvent(false);
                    } else if (moveX - downX1 < 0 && getCurrentItem() < getAdapter().getCount() - 1) {
                        //滑动的是轮播图片，夫控件不能去拦截事件
                        getParent().requestDisallowInterceptTouchEvent(true);
                    } else if (moveX - downX1 > 0 && getCurrentItem() == 0) {
